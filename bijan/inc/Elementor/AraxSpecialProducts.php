...
class AraxSpecialProducts extends \Elementor\Widget_Base {
	public function get_name() {
		return 'bijan_arax_special_products';
	}

	public function get_title() {
		return esc_html__( 'Arax Special Products (Bijan)', 'bijan' );
	}
	...
	protected function render() {
		...
		$settings['style'] = 'products-arax-special';
