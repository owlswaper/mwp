...
<aside id="sidebar" class="sidebar sidebar-blog col-md-3 col-sm-12" aria-label="<?php esc_attr_e( 'Blog Sidebar', 'bijan' ) ?>">
	<section id="widget-area" class="widget-area" role="complementary" aria-label="<?php esc_attr_e( 'Blog Widgets', 'bijan' ) ?>">
