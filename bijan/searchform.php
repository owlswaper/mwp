...
<form role="search" method="get" class="searchform" action="<?php echo esc_url( home_url() ) ?>">
	...
	<div class="input-wrap">
		...
		<input type="search" name="s" class="search-field" placeholder="<?php echo esc_attr_x( 'Search…', 'placeholder', 'bijan' ) ?>" value="<?php echo esc_attr( get_search_query() ) ?>" title="<?php echo esc_attr_x( 'Search for:', 'label', 'bijan' ) ?>" />
	</div>
</form>
