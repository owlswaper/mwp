...
<aside id="sidebar" class="sidebar sidebar-general col-md-3 col-sm-12" aria-label="<?php esc_attr_e( 'Sidebar', 'bijan' ) ?>">
	<section id="widget-area" class="widget-area" role="complementary" aria-label="<?php esc_attr_e( 'Widgets', 'bijan' ) ?>">
