...
<form class="woocommerce-EditAccountForm edit-account" action="" method="post" <?php do_action( 'woocommerce_edit_account_form_tag' ); ?> >
	...
	<fieldset>
		<legend><?php esc_html_e( 'Password change (leave blank to leave unchanged)', 'bijan' ); ?></legend>

		<?php if( Utils::to_bool( get_user_meta( $user->ID, 'has_password', true ) ) ) { ?>
			<p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
				<label for="password_current"><?php esc_html_e( 'Current password', 'bijan' ); ?></label>
