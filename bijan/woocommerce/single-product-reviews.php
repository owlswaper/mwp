		...
		<div id="review_form_wrapper">
			<div id="review_form">
				...
				if ( wc_review_ratings_enabled() ) {
					$comment_form['comment_field'] = '<div class="bijan_comment_stars-wrap">';
					$comment_form['comment_field'] .= '<div class="bijan_comment_star-title">' . esc_html__( 'Your score:', 'bijan' ) . '</div>';
					$comment_form['comment_field'] .= UI::stars( 0, 5, true, 'rating', false );
