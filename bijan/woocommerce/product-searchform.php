...
<form role="search" method="get" class="searchform woocommerce-product-search" action="<?php echo esc_url( home_url( '/' ) ); ?>">
	...
	<div class="input-wrap">
		<button type="submit" value="<?php echo esc_attr_x( 'Search', 'submit button', 'woocommerce' ); ?>" class="button-transparent circle <?php echo esc_attr( wc_wp_theme_get_element_class_name( 'button' ) ); ?>"><i class="bijan-icon-search-normal"></i></button>
