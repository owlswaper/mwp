...
<form class="woocommerce-cart-form bijan-section" action="<?php echo esc_url( wc_get_cart_url() ); ?>" method="post">
	...
	<button type="submit" id="update_cart" class="button<?php echo esc_attr( wc_wp_theme_get_element_class_name( 'button' ) ? ' ' . wc_wp_theme_get_element_class_name( 'button' ) : '' ); ?>" name="update_cart" value="<?php esc_attr_e( 'Update cart', 'woocommerce' ); ?>"><?php esc_html_e( 'Update cart', 'woocommerce' ); ?></button>

	<?php do_action( 'woocommerce_after_cart_table' ); ?>
</form>

<div class="cart_bottom">
	<form class="bijan-section" action="<?php echo esc_url( wc_get_cart_url() ); ?>" method="post">
		<div class="actions">
	...
	<div class="cart-collaterals bijan-section">
		<?php
			/**
